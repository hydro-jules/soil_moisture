...
merge_file = merged_folder + 'merge_1km_tc.nc'
...
smos_file = smos_folder + 'smos_1km.nc'
...
dataset = nc.Dataset(merged_folder + 'merge_1km_tc_no_gap.nc','w',format='NETCDF4')
...
# close file
dataset.close()
os.chmod(merged_folder + 'merge_1km_tc_no_gap.nc',0664)
