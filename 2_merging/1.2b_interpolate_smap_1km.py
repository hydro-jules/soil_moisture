...
smap_mean_file = SMAP_folder + 'smap_1km_mean.nc'
...
dataset = nc.Dataset(SMAP_folder + 'smap_1km_mean_interpolated.nc','w',format='NETCDF4')
# create dimensions
...
# close file
dataset.close()
os.chmod(SMAP_folder + 'smap_1km_mean_interpolated.nc',0664)
