...
b2_file = merged_folder + 'scaling_factor_b2_12.5km.nc'
...
dataset = nc.Dataset(merged_folder + 'b2_interpolated_12.5km.nc','w',format='NETCDF4')
# create dimensions
...
# close file
dataset.close()
os.chmod(merged_folder + 'b2_interpolated_12.5km.nc',0664)
