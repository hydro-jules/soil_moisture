...
for k in range(41):
   ...
   listColsmap9km.append('smap9km' + station_names[k])
...
for k in range(41):
   ...
   listColsmos1km.append('smos1km' + station_names[k])
...
for k in range(41):
   ...
   listColchess.append('chess1km' + station_names[k])
...
for k in range(41):
   ...
   listColtc_merge.append('tc_merge' + station_names[k])
...
for k in range(41):
   ...
   listCols1.append('s1' + station_names[k])
...
for k in range(41):
   ...
   listColsmap_l4.append('smap_l4' + station_names[k])
...
for k in range(41):
   ...
   listColascat12_5km.append('ascat12_5km' + station_names[k])
...
for k in range(41):
   ...
   listColcosmos.append(station_names[k])
...
plt.savefig(plot_dir_1 + site +'_time_series_mean_merged_'+version+'.png',dpi=300,bbox_inches='tight')
plt.close()
