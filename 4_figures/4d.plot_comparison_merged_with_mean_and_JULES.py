...
if GLDAS == False:
    if hamburg==True:
        ...
        plot_dir = '/prj/hydrojules/users/malngu/plots/plots_for_review/number_4_merged_and_mean_and_jules/'+method + '_' + bulk_den + '/'
else:
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir + 'box_corrleation_merge_and_mean_and_jules_with_seasonality_'+version+'.png',dpi=400,bbox_inches='tight')
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir + 'box_crmse_merge_and_mean_and_jules_with_seasonality_'+version+'.png',dpi=400,bbox_inches='tight')
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir +'box_rmse_merge_and_mean_and_jules_with_seasonality_'+version+'.png',dpi=400,bbox_inches='tight')
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir +'box_bias_merge_and_mean_and_jules_with_seasonality_'+version+'.png',dpi=400,bbox_inches='tight')
