...
for site in station_names:
  ...
  # site = 'M5'
    ...
    plt.savefig(plot_dir_1 + site +'_time_series_mean_merged_with_avg2_with_ylim_1.2_'+version+'.png',dpi=300,bbox_inches='tight')
    plt.close()
...
for site in station_names:
  ...
  # site = 'M5'
    ...
    fig.autofmt_xdate()
    fig.text(0.145, 0.7, 'Site: '+site,fontsize=11)
    plt.savefig(plot_dir_2 + site +'_time_series_ascat_smap_with_ylim_1.2_'+version+'.png',dpi=300,bbox_inches='tight')
    plt.close()
...
for site in station_names:
  ...
  # site = 'M5'
    ...
    fig.autofmt_xdate()
    fig.text(0.145, 0.7, 'Site: '+site,fontsize=11)
    plt.savefig(plot_dir_3 + site +'_time_series_jules_merged_with_ylim_1.2_'+version+'.png',dpi=300,bbox_inches='tight')
    plt.close()
