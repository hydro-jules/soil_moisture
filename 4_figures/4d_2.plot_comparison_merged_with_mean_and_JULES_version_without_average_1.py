...
######plot box plot for correlation#################
######plot box plot for correlation#################
R_box = [rvalue_chess[mask_nan],rvalue_tc_merge[mask_nan],rvalue_mean[mask_nan]]
...
ax1.set_xticklabels(['JULES-CHESS','Merge','Average'],fontsize = 11)
ax1.set_ylim([0,1.1])
ax1.yaxis.set_tick_params(labelsize=11)
ax1.set_ylabel(r'$R$',fontsize = 11)
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir + 'box_corrleation_merge_and_mean_and_jules_with_seasonality_without_avg1_'+version+'.png',dpi=400,bbox_inches='tight')
# plt.savefig('box_corrleation_merge_no_seasonality.png',dpi=400,bbox_inches='tight')
plt.close()


######plot box plot for ubRMSE#################
R_box = [crmse_chess[mask_nan],crmse_tc_merge[mask_nan],crmse_mean[mask_nan]]
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir + 'box_crmse_merge_and_mean_and_jules_with_seasonality_without_avg1_'+version+'.png',dpi=400,bbox_inches='tight')
...
R_box = [rmse_chess[mask_nan],rmse_tc_merge[mask_nan],rmse_mean[mask_nan]]
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir +'box_rmse_merge_and_mean_and_jules_with_seasonality_without_avg1_'+version+'.png',dpi=400,bbox_inches='tight')
# plt.savefig('box_rmse_merge_no_seasonality.png',dpi=400,bbox_inches='tight')
plt.close()


R_box = [bias_chess[mask_nan],bias_tc_merge[mask_nan],bias_mean[mask_nan]]
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir +'box_bias_merge_and_mean_and_jules_with_seasonality_without_avg1_'+version+'.png',dpi=400,bbox_inches='tight')
