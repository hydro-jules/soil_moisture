...
plot_dir = '/prj/hydrojules/users/malngu/plots/plots_for_review/number_3_with_anomalies/'+method + '_' + bulk_den + '_wind'+str(window_size)+'/'
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir+'box_corrleation_collocated_no_seasonality_with_ASCAT_'+version+'.png',dpi=400,bbox_inches='tight')
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir+'box_crmse_collocated_no_seasonality_with_ASCAT_'+version+'.png',dpi=400,bbox_inches='tight')
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir+'box_rmse_collocated_no_seasonality_'+version+'.png',dpi=400,bbox_inches='tight')
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir+'box_bias_collocated_no_seasonality_with_ASCAT_'+version+'.png',dpi=400,bbox_inches='tight')
...
for s in new.columns:
    ...
    anomaly = new[s] - mv.moving_average(new[s], window_size=window_size,min_obs=5)
    new[s] = anomaly
...
plt.savefig(plot_dir+'box_TC_error_no_seasonality_with_ASCAT_'+version+'.png',dpi=400,bbox_inches='tight')
...
ax1.set_ylim([0,0.19])
plt.savefig(plot_dir+'All_products_Error_Standard_deviation_no_seasonality_with_ASCAT_'+version+'.png',dpi=600,bbox_inches='tight')
...
ax1.set_xticklabels(['SMOS L4','SMAP L3E','SMAP/Sentinel 1','Sentinel 1','SMAP L4','ASCAT'],fontsize = 11)
ax1.set_ylim([-30,15])
ax1.yaxis.set_ticks(np.arange(-30,15,8))
ax1.yaxis.set_tick_params(labelsize=11)
ax1.set_ylabel('SNR',fontsize = 11)
ax1.grid(True)
fig.autofmt_xdate()

plt.savefig(plot_dir+'box_TC_SNR_no_seasonality_with_ASCAT_'+version+'.png',dpi=400,bbox_inches='tight')
...
#ax1.yaxis.set_ticks(np.arange(0,0.19,0.04))
ax1.set_ylim([-35,+15])
plt.savefig(plot_dir+'All_products_SNR_no_seasonality_with_ASCAT_'+version+'.png',dpi=600,bbox_inches='tight')
# plt.savefig('All_products_Error_Standard_deviation_no_seasonality.png',dpi=600,bbox_inches='tight')
plt.close()