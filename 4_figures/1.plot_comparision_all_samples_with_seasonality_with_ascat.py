# Script for plotting all products (direct sample,not collocated), inlucding box plot, bar plot, and TC standadized erro bar and box plot
...
plot_dir = '/prj/hydrojules/users/malngu/plots/plots_for_review/number_1/'+method + '_' + bulk_den + '/'
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir + 'box_corrleation_no_collocation__with_seasonality_with_ASCAT_'+version+'.png',dpi=400,bbox_inches='tight')
plt.close()
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir + 'box_crmse_no_collocation__with_seasonality_with_ASCAT_'+version+'.png',dpi=400,bbox_inches='tight')
plt.close()
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir + 'box_rmse_no_collocation__with_seasonality_with_ASCAT_'+version+'.png',dpi=400,bbox_inches='tight')
plt.close()
...
ax1.grid(True)
fig.autofmt_xdate()
plt.savefig(plot_dir + 'box_bias_no_collocation__with_seasonality_with_ASCAT_'+version+'.png',dpi=400,bbox_inches='tight')
plt.close()
...
plt.show()
plt.savefig(plot_dir+'no_collocation_error_bar_wiht_seasonality_with_ASCAT_'+version+'.png',dpi=600,bbox_inches='tight')
plt.close()
...
for ax in [ax2,ax3,ax4]:
    ax.set_yticks(ax.get_yticks()[1:])
plt.show()
plt.savefig(plot_dir+'no_collocation_error_HEATMAP_wiht_seasonality_with_ASCAT_NEW_'+version+'.png',dpi=600,bbox_inches='tight')
plt.close()
