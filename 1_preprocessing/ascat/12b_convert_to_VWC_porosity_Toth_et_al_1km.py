...
ascat_file = ascat_folder+'ascat_masked_1km_'+method+'.nc'
...
porosity_file = HWSD_folder+'porosity_Toth_et_al_with_'+bulk_den+'_GAPFILLED_1km.nc'
por_var = 'porosity'
factor = 1.0
...
dataset = Dataset(outFolder+'ascat_VWC_' + outname_root + '_porosity_Toth_et_al_1km.nc','w',format='NETCDF4')
