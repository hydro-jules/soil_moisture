...
porosity_file = HWSD_folder+'porosity_Toth_et_al_with_'+bulk_den+'_1km.nc'
hamburg_file = HWSD_folder+'ASCAT_Hamburg_porosity_1km.nc'
...
dataset = Dataset(outFolder+'porosity_Toth_et_al_with_'+bulk_den+'_GAPFILLED_1km.nc','w',format='NETCDF4')
