...
# path to HWSD 12.5km file
HWSDfolder = input_file.readline()[:-1]

bulk_density_file = HWSDfolder+bulk_den+'_12.5km.nc'
ph_file = HWSDfolder+'T_PH_H2O_12.5km.nc'
clay_file = HWSDfolder+'T_CLAY_12.5km.nc'
...
dataset = Dataset(outFolder+'porosity_Toth_et_al_with_'+bulk_den+'_12.5km.nc','w',format='NETCDF4')
