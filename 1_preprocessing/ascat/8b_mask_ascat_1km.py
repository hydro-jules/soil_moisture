...
#chess_file = '/prj/hydrojules/data/soil_moisture/preprocessed/data_for_review/chess_1km.nc'
ascat_file = ascat_folder + 'ascat_1km_'+method+'.nc'
...
dataset = Dataset(outFolder+'ascat_masked_1km_'+method+'.nc','w',format='NETCDF4')
